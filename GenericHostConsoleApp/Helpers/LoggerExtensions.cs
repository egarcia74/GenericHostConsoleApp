...
public static partial class LoggerExtensions
{
    ...
    /// <param name="ex">The unhandled exception.</param>
    /// <param name="logger">The <see cref="ILogger{TCategoryName}" /> to use.</param>
    [LoggerMessage(2, LogLevel.Critical, "An argument exception has occurred.")]
    ...
    /// <param name="logger">The <see cref="ILogger{TCategoryName}" /> to use.</param>
    [LoggerMessage(3, LogLevel.Critical, "An invalid argument exception has occurred.")]
    ...
    /// </summary>
    /// <param name="logger">The <see cref="ILogger{TCategoryName}" /> to use.</param>
    [LoggerMessage(4, LogLevel.Information, "Application was cancelled.")]
    ...
    /// </summary>
    /// <param name="logger">The <see cref="ILogger{TCategoryName}" /> to use.</param>
    [LoggerMessage(5, LogLevel.Information, "Application is starting.")]
    ...
    [LoggerMessage(6, LogLevel.Information, "Application has started with args: \"{Args}\".")]
    ...
    /// </summary>
    /// <param name="logger">The <see cref="ILogger{TCategoryName}" /> to use.</param>
    [LoggerMessage(7, LogLevel.Information, "Application is stopping.")]
    ...
    /// </summary>
    /// <param name="logger">The <see cref="ILogger{TCategoryName}" /> to use.</param>
    [LoggerMessage(8, LogLevel.Information, "Application has stopped.")]
    ...
    [LoggerMessage(9, LogLevel.Information, "Application is exiting with exit code: {ExitCode} ({ExitCodeAsInt}).")]
    ...
    [LoggerMessage(10, LogLevel.Information, "Configuration: {Name} = {Value}")]
